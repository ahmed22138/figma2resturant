    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="w-full max-w-5xl flex flex-col justify-center items-center text-white mb-10">
          <p className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 mt-24 text-center">404 Error</p>
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4 mb-4">
            {/* <p className="text-xl sm:text-2xl md:text-3xl text-[20px]">Home</p> */}
            <div className="flex items-center">
              <Image 
                src="/images/22121.png" 
                width={200} 
                height={150} 
      ...
      {/* Signup Form Section */}
      <section className="p-28 relative bg-white pt-24 flex flex-col items-center">
