...
<>
  ...
  >
    <h1 className="mt-20 text-white text-5xl">Cheekout Page</h1><br/>
     <h2 className="text-white -ml-56 mt-44 ">Home</h2> <p className="mt-44 ml-6 text-amber-500">Cheekout</p>
    </div>
